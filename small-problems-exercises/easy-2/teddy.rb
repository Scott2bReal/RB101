...
-  Inputs: None
-  Output: "Teddy is 20-200 years old!"
...
Need to know which method will work well. Kernel.rand was recommended
---
...
Print Teddy's age. He is anywhere from 20 - 200 years old.
...
-  You want something tat you can readily convert to code without actually
   writing code.
...
puts 'Someone might be young or old. What is their name?'
answer = gets.chomp
