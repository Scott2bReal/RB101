...
# puts "three is: #{three}"
#
# A will print "one is one, two is two, three is three" because the variables
# are just being reassigned within the method scope
#
# B will print "one is one, two is two, three is three" for the same reason
#
# C will print "one is two, two is three, three is one" because the gsub! method
# mutates the caller
