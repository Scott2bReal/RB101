...
distances is the biggest possible to please Mary and John?  Example:
...
zero integers and this list has at least one element). The function returns the
...
With C, C++, Dart, Fortran, F#, Go, Julia, Kotlin, Nim, OCaml, Pascal, Perl,
...
def choose_best_sum(max_distance, 
