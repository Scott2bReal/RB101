...
always be given an array with five six-sided dice values.
 ...
 Three 4's =>  400 points Three 3's =>  300 points Three 2's =>  200 points One
 1   =>  100 points One   5   =>   50 point
...
Example scoring
 ...
 Throw       Score ---------   ------------------ 5 1 3 4 1   250:  50 (for the
 5) + 2 * 100 (for the 1s) 1 1 1 3 1   1100: 1000 (for three 1s) + 100 (for the
 other 1) 2 4 4 5 4   450:  400 (for three 4s) + 50 (for the 5)
...
Output: Max greed score possible with those rolls

Data Structure: Array

Algorithm
  - Establish a constant SCORES
  - group rolls by roll
  - If
...
def score(rolls)
  roll_counts = rolls.group_by { |roll| roll }
end
