...
a or b might be nil or null or None or nothing (except in Haskell, Elixir, C++,
Rust, R, Shell, PureScript).
...
Algorithm:
  sort both arrays
  for each with index in array a
    if num at idx in b != a*a return false
...
def comp(array1, array2)
  ...
  sorted1, sorted2 = array1.sort, array2.sort
  sorted1.each_with_index { |num, idx| return false unless sorted2[idx] == num * num }
  true
end
